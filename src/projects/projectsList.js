...
/* Images */
import pixelGif from "../images/art-with-pixels.gif";
...
const shoppingCart = refineToCard("Shopping cart (a melhorar)", "Modelo simples de carrinho de compras", "HTML CSS JS", "Aprofundando no DOM", "", "https://jrgcast.github.io/shopping-cart-simple-htmlcssjs/", "https://github.com/JRGCast/shopping-cart-simple-htmlcssjs");
